                            ...
                            <div class="comment">
                                <div class="row">
                                    <div class="col-md-8">
                                        ...
                                        <div class="options">
                                            <a href="#reply_2" data-toggle="collapse" aria-expanded="false" aria-controls="reply_2" class="btn btn-framed btn-primary btn-rounded btn-small icon">Reply<i class="fa fa-reply font-color-default"></i></a>
                                        </div>
                                        <!--end options-->
                                        <div class="collapse" id="reply_2">
                                            <div class="answer">
                                                <form class="form labels-uppercase clearfix" id="form_reply_2">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="form_reply_1-name">Your Name<em>*</em></label>
                            ...
                            <div class="comment">
                                <div class="row">
                                    <div class="col-md-8">
                                        ...
                                        <div class="options">
                                            <a href="#reply_3" data-toggle="collapse" aria-expanded="false" aria-controls="reply_3" class="btn btn-framed btn-primary btn-rounded btn-small icon">Reply<i class="fa fa-reply font-color-default"></i></a>
                                        </div>
                                        <!--end options-->
                                        <div class="collapse" id="reply_3">
                                            <div class="answer">
                                                <form class="form labels-uppercase clearfix" id="form_reply_3">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="form_reply_1-name">Your Name<em>*</em></label>
