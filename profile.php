                        ...
                        <form class="form inputs-underline">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <p>Georgette.dujardin@taboite.fr</p>
                                        </div>
                                        <!--end form-group-->
                                    </div>
                                    <!--end col-md-6-->
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <p>Georgette petit papillon de lumière</p>
                                            </div>
                                        <!--end form-group-->
                                    </div>
                                    <!--end col-md-6-->
                            ...
                            <section class="center">
                                <div class="form-group">
                                    ...
                                    <a href="profile1.php"><input type="button" name="Modifier"value="Modifier"/></a>
                                </div>
                                <!--end form-group-->
                            </section>
                        </form>
        ...
        <section>
            <div class="row">
                <div class="col-md-4 col-sm-4 col-md-offset-4 col-sm-offset-4">
                    <h3 class="center">Vos dernières recherches</h3>
